...
data class SubmissionWithExecutionResponseBodyDTO(
    val id: UUID,
...
fun Submission.toWithExecutionResponseBodyDTO(): SubmissionWithExecutionResponseBodyDTO =
    SubmissionWithExecutionResponseBodyDTO(
        id = id,

...
class BuildStaffDashboardServiceTest :
    FunSpec({
        ...
        test("should throw ForbiddenException if member is not staff") {
        ...
        test("should build staff dashboard successfully") {
            val contest = ContestMockBuilder.build()

...
class CreateExecutionInternalServiceTest :
    FunSpec({
        ...
        context("create") {
            test("should throw ForbiddenException if input attachment context is not PROBLEM_TEST_CASES") {
                val command =
                    CreateExecutionInternalUseCase.Command(
                        ...
                        input = AttachmentMockBuilder.build(context = Attachment.Context.SUBMISSION_CODE),
            ...
            test("should create execution") {
                ...
                val command =
                    CreateExecutionInternalUseCase.Command(
                        ...
                        totalTestCases = 10,
                        approvedTestCases = 10,
                        input = AttachmentMockBuilder.build(context = Attachment.Context.PROBLEM_TEST_CASES),
                        output = listOf("output1", "output2", "output3"),
                    )

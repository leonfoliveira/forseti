...
export type ContestantDashboardBroadcastCallbacks = {
...
export class ContestantDashboardBroadcastRoom extends BroadcastRoom<ContestantDashboardBroadcastCallbacks> {
  constructor(
    contestId: string,
    public callbacks: ContestantDashboardBroadcastCallbacks,
  ) {
    super(`contests/${contestId}/contestant`, callbacks);
  }
}

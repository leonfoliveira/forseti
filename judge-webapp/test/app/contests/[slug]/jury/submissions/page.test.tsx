...
import JurySubmissionsPage from "@/app/contests/[slug]/jury/submissions/page";
...
describe("JurySubmissionsPage", () => {
  it("should render all components on startup", () => {
    (useJuryContext as jest.Mock).mockReturnValue({
      submissions: [
        {
          id: "1",

...
describe("AxiosContestRepository", () => {
  ...
  describe("createContest", () => {
    it("should create a contest and return the full response", async () => {
      const requestDTO = { name: "Contest 1" } as any;
      const expectedResponse = { id: "contest123" } as ContestFullResponseDTO;
      axiosClient.post.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.createContest(requestDTO);

      expect(axiosClient.post).toHaveBeenCalledWith("/v1/contests", { data: requestDTO });
  ...
  describe("updateContest", () => {
    it("should update a contest and return the full response", async () => {
      const requestDTO = { id: "contest123", name: "Contest 1 Updated" } as any;
      const expectedResponse = { id: "contest123", name: "Contest 1 Updated" } as ContestFullResponseDTO;
      axiosClient.put.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.updateContest(requestDTO);

      expect(axiosClient.put).toHaveBeenCalledWith("/v1/contests", { data: requestDTO });
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("findAllContestMetadata", () => {
    it("should return an array of contest metadata", async () => {
      const expectedResponse = [{ id: "contest123" }] as ContestMetadataResponseDTO[];
      axiosClient.get.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);
  ...
  describe("findContestMetadataBySlug", () => {
    it("should return contest metadata by slug", async () => {
      ...
      expect(axiosClient.get).toHaveBeenCalledWith(`/v1/contests/slug/${slug}/metadata`);
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("findContestLeaderboardById", () => {
    it("should return a contest leaderboard", async () => {
      const id = "contest123";
      const expectedResponse = { id: "contest123" } as ContestLeaderboardResponseDTO;
      axiosClient.get.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.findContestLeaderboardById(id);

      expect(axiosClient.get).toHaveBeenCalledWith(`/v1/contests/${id}/leaderboard`);
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("findAllContestSubmissions", () => {
    it("should return an array of public submissions", async () => {
      const id = "contest123";
      const expectedResponse = [{ id: "submission123" }] as SubmissionPublicResponseDTO[];
      axiosClient.get.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.findAllContestSubmissions(id);

      expect(axiosClient.get).toHaveBeenCalledWith(`/v1/contests/${id}/submissions`);
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("findAllContestFullSubmissions", () => {
    it("should return an array of full submissions", async () => {
      const id = "contest123";
      const expectedResponse = [{ id: "submission123" }] as SubmissionFullResponseDTO[];
      axiosClient.get.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.findAllContestFullSubmissions(id);

      expect(axiosClient.get).toHaveBeenCalledWith(`/v1/contests/${id}/submissions/full`);
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("createAnnouncement", () => {
    it("should create an announcement and return the response", async () => {
      ...
      const expectedResponse = { id: "announcement123" } as AnnouncementResponseDTO;
      axiosClient.post.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.createAnnouncement(id, requestDTO);

      expect(axiosClient.post).toHaveBeenCalledWith(`/v1/contests/${id}/announcements`, { data: requestDTO });
      expect(result).toEqual(expectedResponse);
    });
  });
  ...
  describe("createClarification", () => {
    it("should create a clarification and return the response", async () => {
      ...
      const expectedResponse = { id: "clarification123" } as ClarificationResponseDTO;
      axiosClient.post.mockResolvedValueOnce({ data: expectedResponse } as AxiosResponse);

      const result = await sut.createClarification(id, requestDTO);

      expect(axiosClient.post).toHaveBeenCalledWith(`/v1/contests/${id}/clarifications`, { data: requestDTO });
      expect(result).toEqual(expectedResponse);
    });
  });
});

...
const paths = {
  ...
  CONTEST_JUDGE: `/contests/{slug}/judge`,
  CONTEST_JUDGE_LEADERBOARD: `/contests/{slug}/judge/leaderboard`,
  CONTEST_JUDGE_PROBLEMS: `/contests/{slug}/judge/problems`,
  CONTEST_JUDGE_SUBMISSIONS: `/contests/{slug}/judge/submissions`,
  CONTEST_JUDGE_CLARIFICATIONS: `/contests/{slug}/judge/clarifications`,
  CONTEST_JUDGE_ANNOUNCEMENTS: `/contests/{slug}/judge/announcements`,
...
export const routes = {
  ...
  CONTEST_JUDGE_PROBLEMS: withSlug(paths.CONTEST_JUDGE_PROBLEMS),
  CONTEST_JUDGE_SUBMISSIONS: withSlug(paths.CONTEST_JUDGE_SUBMISSIONS),
  CONTEST_JUDGE_CLARIFICATIONS: withSlug(paths.CONTEST_JUDGE_CLARIFICATIONS),
  CONTEST_JUDGE_ANNOUNCEMENTS: withSlug(paths.CONTEST_JUDGE_ANNOUNCEMENTS),

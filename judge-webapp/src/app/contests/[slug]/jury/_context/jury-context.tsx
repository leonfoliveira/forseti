...
export function JuryContextProvider({
  ...
  return (
    <JuryContext.Provider value={state.data!}>{children}</JuryContext.Provider>
  );
}

export function useJuryContext() {

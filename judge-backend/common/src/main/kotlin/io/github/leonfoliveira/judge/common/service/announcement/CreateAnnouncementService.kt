...
import io.github.leonfoliveira.judge.common.event.AnnouncementCommonEvents
...
class CreateAnnouncementService(
    ...
    fun create(
        ...
        applicationEventPublisher.publishEvent(AnnouncementCommonEvents(this, announcement))

...
class WebSocketTopicConfigsTest : FunSpec({
    ...
    afterEach {
        unmockkObject(AuthorizationContextUtil)
    }
    ...
    context("privateFilters") {
        ...
        context("announcements filter") {
            ...
            test("should return true when contest access is allowed") {
                ...
                val filter = sut.privateFilters.entries.first { it.key.pattern.contains("announcements") }.value

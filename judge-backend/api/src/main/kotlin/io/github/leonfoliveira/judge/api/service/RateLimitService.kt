...
class RateLimitService {
    ...
    private val cache: Cache<String, TokenBucket> = Caffeine.newBuilder()
        .maximumSize(100_000)
    ...
    private fun getBucket(
        ...
        return cache.get(key) {
            TokenBucket(requestsPerMinute, requestsPerHour, burstCapacity)
        }!!
    }
    ...
    private class TokenBucket(
        ...
        private fun refillTokens() {
            ...
            if (currentSecond > lastBurstRefill) {
                ...
                val tokensToAdd = minOf(
                    secondsElapsed * burstCapacity / 60, // Refill rate based on burst capacity

...
import { submissionFormSchema } from "@/app/contests/[slug]/submissions/_form/submission-form-schema";
...
import { toInputDTO } from "@/app/contests/[slug]/submissions/_form/submission-form-map";
...
export default function ContestSubmissionPage() {
  ...
  useEffect(() => {
    if (authorization) {
      findAllSubmissionsForMemberAction.act(
        contest.id,
